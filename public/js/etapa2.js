...
function submitForm() {
    ...
    const frequencia_visita_Podologo = sessionStorage.getItem('frequencia_podologo');
    const uso_medicamento = sessionStorage.getItem('uso_medicamentos');
    const tipo_medicamento = sessionStorage.getItem('quais_medicamentos');
    const alergico = sessionStorage.getItem('alergico');
    const alergia_substancia = sessionStorage.getItem('quais_substancias');
    ...
    const menstruacao = sessionStorage.getItem('ciclo_menstruacao_regular');
